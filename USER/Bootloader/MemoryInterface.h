...
#define BOOTLOADER_TEMP_VER	(0x08001F40)
#define BOOTLOADER_TEMP_LEN	(0x08001F44)
#define BOOTLOADER_TEMP_CRC	(0x08001F48)

#define BOOTLOADER_ERROR_CODE	(0x08001F60)

#define MAIN_PROG_ADDRESS		(0x08002000)
#define TEMP_PROG_ADDRESS		(0x08009000)

#define MEMORY_INTERFACE_DEBUG
#ifdef MEMORY_INTERFACE_DEBUG
